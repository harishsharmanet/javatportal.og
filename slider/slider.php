                        ...
                        <div class="row justify-content-center">
                            ...
                            <!--<form autocomplete="off" action="/action_page.php" >
                              <div class="form-group">
                               <input id="myInput" type="text" name="myCountry" placeholder="Start typing your desired course here." class="form-control" >
                              </div>
