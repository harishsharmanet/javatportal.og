                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">Advance Spring Framework</a></li>
                                    <li><a class="dropdown-item" href="#">Advance Hibernate </a></li>
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">PHP/MySQL (Core + Advance)</a></li>
                                    <li><a class="dropdown-item" href="#">PHP Frameworks</a></li>
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">AWS Developer – Associate</a></li>
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">Software Testing – (Using QTP/UFT)</a></li>
