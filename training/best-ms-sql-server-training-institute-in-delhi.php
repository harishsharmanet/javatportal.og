    ...
    <body>
        ...
        <div class="jumbotron">
            <div class="opacity-effect">
                <h1 class="display-3"><i class="fas fa-database"></i>&nbsp;SQL Server Training Institute in Delhi</h1>
                <h4>JavaTportal Corporation offers best SQL Server Training in Delhi with most experienced professionals</h4>
                            ...
                            <div class="card-header" id="headingTwo">
                                <h8 class="mb-0">
                                    <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="fas fa-chevron-circle-down"></i>   SQL Server Placement Training in Noida
                                    </button>
                                </h8>
                            </div>
                            ...
                            <div class="card-header" id="headingThree">
                                <h8 class="mb-0">
                                    <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        <i class="fas fa-chevron-circle-down"></i>   SQL Server Training Batch Size in Noida
                                    </button>
                                </h8>
                            </div>
